...
src="$CURRENT_LINK/.config/spicetify/Themes/odyssey"
dest="$HOME/.config/spicetify/Themes/odyssey"
...
spicetify config current_theme odyssey color_scheme base &>/dev/null
